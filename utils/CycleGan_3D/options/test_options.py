...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--image", type=str, default='./Data_folder/test/0.nii.gz')
        parser.add_argument("--result", type=str, default='./Data_folder/test/result_0.nii', help='path to the .nii result to save')
